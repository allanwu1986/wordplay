...
from word2description.consumers import QuestionerConsumer, QuestionerPoolConsumer, AnswererConsumer, AnswererPoolConsumer
...
application = ProtocolTypeRouter({
    ...
    "websocket": AuthMiddlewareStack(
        URLRouter([
            ...
            path("connect/questioner/", QuestionerConsumer),
            path("connect/answerer/", AnswererConsumer),
            path("connect/questioner_pool/", QuestionerPoolConsumer),
            path("connect/answerer_pool/", AnswererPoolConsumer),
        ]),
    ),
